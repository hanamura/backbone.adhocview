(function() {
  ...
  AdhocView = (function(_super) {
    ...
    AdhocView.prototype.position = function(position) {
      ...
      if (position !== void 0) {
        some = false;
        if ('x' in position && this._x !== position.x) {
          this._x = position.x;
          some = true;
        }
        if ('y' in position && this._y !== position.y) {
          this._y = position.y;
          some = true;
        }
        if (some) {
    ...
    AdhocView.prototype.size = function(size) {
      ...
      if (size !== void 0) {
        some = false;
        if ('width' in size && this._width !== size.width) {
          this._width = size.width;
          some = true;
        }
        if ('height' in size && this._height !== size.height) {
